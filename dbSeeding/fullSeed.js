...
db.plants.insertMany([
  ...
  },
  {
        ...
        "Sunlight": "Pick a spot that gets at least 6 hours of direct sunlight per day.",
        "Support": 'No requirements',
        "Spacing": 'No requirements',
   ...
   },
   {
        ...
        "Sunlight": "Beans need a sunny, well-drained area rich in organic matter.",
        "Support": "No requirements",
        "Spacing": "Plant most bush cultivars 3 to 6 inches apart in rows 2 to 2½ feet apart.",
   ...
   },
   {
        ...
        "Support": "No requirements",
        "Spacing": "Brussels sprouts get large, so they need to be about 18 to 24 inches apart in a row or bed. If planted in rows, space rows 30 inches apart to give yourself enough room to walk.",
        "Water": "Water regularly",
   ...
   },
   {
        ...
        "Sunlight": "Like most vegetables, beets prefer growing in full sun.",
        "Support": "No requirements",
        "Spacing": "When growing beets, plant the seeds 1 to 2 inches apart in the row.",
        "Water": "Water regularly",
   ...
   },
   {
        ...
        "Sunlight": "Carrot tops need full sun to light shade, for the carrots to grow quickly and develop their sugars.",
        "Support": "No requirements",
        "Spacing": "Thin to 1 inch apart when the tops are 2 inches high, and be thorough, because crowded carrots will produce crooked roots. Thin again 2 weeks later to 3 to 4 inches apart.",
        "Water": "Water gently",
